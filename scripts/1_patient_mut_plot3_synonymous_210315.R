...
# variant dynamics
# timepoint for VL
# synonymous mutations in background
...
for(i in iter){
  ...
  dat.header = data.frame(patient = c("22828", "22763", "16207","15664","29219","31254"), header = c("SYN - Patient 22828, Female, 28yrs",
                                                                                                     "SYN - Patient 22763, Female, 42yrs",
                                                                                                     "SYN - Patient 16207, Female, 35yrs",
                                                                                                     "SYN - Patient 15664, Male, 51yrs",
                                                                                                     "SYN - Patient 29219, something something",
                                                                                                     "SYN - Patient 31254, something something"))
